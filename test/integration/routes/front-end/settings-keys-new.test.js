...
describe('GET /settings/keys/new', () => {
	...
	describe('when a user is logged in', () => {
		...
		beforeEach(async () => {
			response = await request.get('/settings/keys/new', {
		...
		it('responds with an edit key form', () => {
			...
			assert.strictEqual(form.getAttribute('action'), '/settings/keys/new');
			...
			assert.strictEqual(descriptionField.getAttribute('value'), '');
		});
